...
16. **Summary:** `{summary: true, funnel, first_pass_rate, recovery_cycles, parity_verdict, parity_tenant, hygiene_verdict, handoff_discipline_verdict, tool_calls, turns, tokens_in, tokens_out}`
...
{"summary":true,"funnel":["S0","S1","S2","S3","S4","S5","S6","S7","S8","S9","S10","S11"],"first_pass_rate":1.0,"recovery_cycles":0,"parity_verdict":"PASS","parity_tenant":"not_applicable","hygiene_verdict":"PASS","handoff_discipline_verdict":true,"tool_calls":42,"turns":8,"tokens_in":null,"tokens_out":null}
```
