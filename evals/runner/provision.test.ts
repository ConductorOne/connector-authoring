// provision.test.ts — unit smoke for the create_env args builder (locked D14).
// The reasoning-effort pin is an ENV-level field (squire.create_env
// omp_reasoning_effort), not a task.create field — the passthrough assertion
// lives here so the mechanism cannot silently regress.
...
test("provisionEnvArgs passes the scenario reasoningEffort as omp_reasoning_effort", () => {
...
test("provisionEnvArgs reflects a low reasoningEffort pin", () => {
