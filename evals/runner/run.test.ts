...
const SCENARIO_GUIDE_ONLY: Scenario = {
  id: "tier1-directory",
  name: "Tier 1: Directory API sync funnel",
  fixture: {
    port: 18080,
...
test("buildRunMeta carries the scenario reasoning-effort pin and skill-bundle mode", () => {
  const meta = buildRunMeta("r", SCENARIO_GUIDE_ONLY, "inherit", "2026-09-03T00:00:00.000Z", 123456, true)
  ...
  assert.equal(meta.model_version, SCENARIO_GUIDE_ONLY.model)
